  ...
  const STYLES = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .file-drop {
      ...
      width: 100%;
      padding: 11px 15px;
      border: 1.5px dashed var(--border-file);
      border-radius: 10px;
    ...
    .file-drop-error { border-color: var(--border-error) !important; }
    .file-drop-text { color: var(--text-file); }
        ...
        {loading && (
          <div className="submit-overlay" role="status" aria-live="polite">
            <div className="submit-overlay-card">
              ...
              <p className="submit-overlay-text">Creating your account…</p>
            </div>
          </div>
        )}
          ...
          <div className="form-col">
            ...
            >
              ...
              <div className="form-header">
                ...
                <p className="sub">
                  Already have one? <Link to="/auth/login">Sign in</Link>
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                >
                  <input
                    ...
                    placeholder="Aritra Roy" autoComplete="name"
                  />
                </Field>
                ...
                <div className="two-col">
                  ...
                  >
                    <input
                      ...
                      type="password" name="confirmPassword" value={user.confirmPassword}
                ...
                >
                  <input
                    ...
                    placeholder="123 Main St, City" autoComplete="street-address"
                  />
                </Field>
                ...
                <div className="field">
                  ...
                  <label className={`file-drop${error.profileImage ? " file-drop-error" : ""}`}>
                    <input type="file" accept="image/*" onChange={onImageChange} style={{ display: "none" }} />
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" style={{ flexShrink: 0 }}>
                      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                      <polyline points="17 8 12 3 7 8" />
                      <line x1="12" y1="3" x2="12" y2="15" />
                    </svg>
                    <span className="file-drop-text">
                      {avatarPreview ? "Image selected — click to change" : "Click to upload a photo"}
                    </span>
                  </label>
                  {error.profileImage && (
                    <p className="field-error">
